...
st.markdown("# :red[🏃แอพลิเคชันคำนวนค่าดัชนีมวลกาย BMI]")
...
if bmi < 18.5:
    st.warning("🚨คุณมีน้ำหนักน้อยกว่าเกณฑ์ (ผอม)🚨")
      ...
      st.error("⚠️คุณอยู่ในเกณฑ์อ้วน ควรระวังเรื่องสุขภาพและออกกำลังกาย⚠️")
st.divider()
st.write("นาย ปณิธาน แก้วอาจ เลขที่ 25 ม.4/7")
