...
# กำหนด Session State สำหรับเก็บค่าของทั้ง 4 ข้อ
...
ans3 = st.text_input(
    "ข้อ 3: I use my l _ p t _ p for coding. 💻",
    value=st.session_state.ans3_val,
)
ans4 = st.text_input(
    "ข้อ 4: Pass me the s c _ s s _ r s to cut paper. ✂️",
    value=st.session_state.ans4_val,
)

# บันทึกค่าลงใน session_state
